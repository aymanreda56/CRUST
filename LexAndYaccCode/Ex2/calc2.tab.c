...
#line 21 "calc2.y"
                                        { printf("%d\n", yyvsp[0]); }
#line 1084 "calc2.tab.c"
    break;

  case 5: /* statement: VARIABLE '=' expression  */
#line 22 "calc2.y"
                                        { sym[yyvsp[-2]] = yyvsp[0]; }
#line 1090 "calc2.tab.c"
    break;
